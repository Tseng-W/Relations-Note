...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
  ...
  func sceneWillEnterForeground(_ scene: UIScene) {
    ...
    UserDefaults.standard.setValue("mockAppleID3", forKey: UserDefaults.Keys.uid.rawValue)
    UserDefaults.standard.setValue("mockEmail3", forKey: UserDefaults.Keys.email.rawValue)
